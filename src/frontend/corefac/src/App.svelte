...
<div class="tabs is-toggle is-centered is-small">
	<ul>
    <li class={tabshow === 'protocols' ? 'is-active': ''}><a on:click={e => tabshow = 'protocols'}>
        <span>Protocols</span>
    </li>
    <li class={tabshow === 'pipelines' ? 'is-active': ''}><a on:click={e => tabshow = 'pipelines'}>
        <span>Prep pipelines</span>
    </li>
    <li class={tabshow === 'dashboard' ? 'is-active': ''}><a on:click={e => tabshow = 'dashboard'}>
        <span>Dashboard</span>
    </li>
	</ul>
</div>

  {#if tabshow === 'protocols'}

  <Protocols on:error={e => showError(e.detail.error)} />

  {:else if tabshow === 'admin'}
  <div class="columns">
    <div class="column">
